...
int BuzzerPin = 25;
int notalar[] = {(unsigned int)262, (unsigned int)294, (unsigned int)330, (unsigned int)349, (unsigned int)392, (unsigned int)440, (unsigned int)494, (unsigned int)523};
...
int KLed = 24; int YLed = 23; int SLed = 26;
long g=0;
int Durum = 0;
